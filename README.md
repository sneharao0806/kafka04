...
```PowerShell
java -cp .\target\kafka04-1.0-SNAPSHOT-jar-with-dependencies.jar edu.northwest.sneha.CustomConsumer
```
...
```PowerShell
java -cp .\target\kafka04-1.0-SNAPSHOT-jar-with-dependencies.jar edu.northwest.sneha.CustomProducer
```
